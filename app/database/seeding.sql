...
INSERT INTO estate(name, price,type,location_id, parking_id)
VALUES ('Appartement de Clermont',200000,'Appartement', 5,2 );

INSERT INTO estate(name, price,type,location_id, parking_id)
VALUES ('Maison à Bry',1000000, 'Maison',3,1 );

INSERT INTO parking (name,price,location_id)
VALUES('Parking de la maison de Paris 8',150000,2);